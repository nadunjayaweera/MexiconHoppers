  ...
  return (
    ...
    >
      <div class="popupbox" id="popup" >
        <div class="popup">
            <img id="close2" onClick={handleclose} src="https://moveyellow.com/public/assets/images/close.png" alt=""/>
            <div>

       
<h1 style={{color:'black',}}>
New Sale Here {salesData}

</h1>
<div>
  <img  style={{maxWidth:"40px",}} src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-bell-512.png" alt="" />
  </div>   
  <button onClick={handleclose} style={{width:'120px', height:'40px', border:'none', color:'white', background:'black'}}>Close</button>         </div>
        </div>
    </div>
