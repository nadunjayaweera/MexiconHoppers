...
export default function FormEditProduct() {
  ...
  const handleFormChange = (event) => {
    ...
    setFormData((prevFormData) => ({
      ...prevFormData,
      [name]: value,
      promotionStatus: name === "promotionStatus" ? value : prevFormData.promotionStatus,
    }));
  };
  ...
  const handleSubmit = (event) => {
    ...
    fetch(`http://acdassanayake.me:8080/api/v1/updateproduct/${currentProductId}`, {
      method: "PUT",
      headers: {
      ...
      <Grid container spacing={3} className={classes.container}>
        ...
        <Grid item xs={12} md={6}>
          <RadioGroup
            ...
            row
          >
            <FormControlLabel value="notPromoted" control={<Radio />} label="Not Promoted" />
